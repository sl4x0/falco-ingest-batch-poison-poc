...
func TestMain(m *testing.M) {
	...
	// HARNESS-ONLY CHANGE (see ../README.md): the upstream TestMain returns without
	// ever calling m.Run(), so every test in this package silently never executes.
	// Restoring the normal TestMain contract is required for any test in this
	// package to run at all.
	os.Exit(m.Run())
}
